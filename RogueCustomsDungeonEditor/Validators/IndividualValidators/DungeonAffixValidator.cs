...
namespace RogueCustomsDungeonEditor.Validators.IndividualValidators
{
    public static class DungeonAffixValidator
    {
        ...
        public static async Task<DungeonValidationMessages> Validate(AffixInfo affixJson, DungeonInfo dungeonJson, Dungeon sampleDungeon)
        {
            ...
            if (!string.IsNullOrWhiteSpace(affixJson.Id))
            {
                ...
                if (affixJson.RequiredPlayerLevel > maximumPlayerLevel)
